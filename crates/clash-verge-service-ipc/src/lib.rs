...
pub static IPC_PATH: &str = "/tmp/muacloud/muacloud-service.sock";
#[cfg(all(windows, not(feature = "test")))]
pub static IPC_PATH: &str = r"\\.\pipe\muacloud-service";

#[cfg(all(feature = "test", unix))]
pub static IPC_PATH: &str = "/tmp/muacloud-service-ipc-test/service.sock";
#[cfg(all(feature = "test", windows))]
pub static IPC_PATH: &str = r"\\.\pipe\muacloud-service-test";
